...
void AddProductUI::enterInformation(ifstream& fin, string& productName, string& companyName, int& cost, int& quantityLeft) //추가한 부분 
{
...
void SatisfactionScoreUI::enterNameAndScore(ifstream& fin, string& productName, int& score) //추가된 부분
{
